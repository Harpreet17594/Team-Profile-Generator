...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card-header bg-primary">
                <h2 class="card-title">${internAnswers.internName}</h2>
                <h3 class="card-title"><i class="fas fa-user-graduate mr-2"></i>${answers1.options}</h3>
            </div>
            <div class="card-body">
                <ul class="list-group">
                    <li class="list-group-item">ID: ${internAnswers.internId}</li>
                    <li class="list-group-item">Email: <a href="mailto:${internAnswers.internEmail}">${internQuestions.internGithub}</a></li>
                    <li class="list-group-item">Github: ${internAnswers.internGithub}</li>
    ...
    <div class="card-header bg-primary">
        ...
        <h3 class="card-title"><i class="fas fa-user-graduate mr-2"></i>${answers.options}</h3>
    </div>
    <div class="card-body">
        <ul class="list-group">
            <li class="list-group-item">ID: ${engAnswers.engId}</li>
            <li class="list-group-item">Email: <a href="mailto:${engAnswers.engEmail}"></a></li>
